...
function fetchAlertReviewChangeLimitData(...params) {
    ...
    seriesData.push({ name: params[6], data: lowerLimitData, color: '#FFF', marker: { radius: 2, symbol: 'circle' } });
    seriesData.push({ name: params[7], data: upperLimitData, color: '#FFF', marker: { radius: 2, symbol: 'circle' } });
