$(function () {
    Highcharts.theme = {
        ...
        xAxis: {
            text: undefined,
            gridLineColor: 'rgba(177, 177, 177)',
            lineColor: 'rgba(177, 177, 177)',
            minorGridLineColor: 'rgba(177, 177, 177)',
            tickColor: 'rgba(177, 177, 177)',
            labels: {
                style: {
                    color: '#000000'
                },
...
function fetchRmaScatterData(...params) {
    ...
    seriesData.push({ name: params[5], data: anomalyData, color: 'rgba(255, 107, 187, 0.5)', marker: { radius: 2, symbol: 'circle' } });
    seriesData.push({ name: params[6], data: falseFailureData, color: 'rgba(255, 160, 122, 0.5)', marker: { radius: 4, symbol: 'triangle-down' } });
    seriesData.push({ name: params[8], data: lowerLimitData, color: '#000', marker: { radius: 2, symbol: 'circle' } });
    seriesData.push({ name: params[9], data: upperLimitData, color: '#000', marker: { radius: 2, symbol: 'circle' } });
...
function fetchPATChartData(...params) {
    ...
    seriesData.push({ name: params[8], data: limit, color: '#000000', marker: { radius: 2, symbol: 'circle' } });
