...
class TestResultChangeLimitDTO {
  ResponseStatusDTO? status;
  List<TestResultChangeLimitDataDTO>? data;
  int? errorCode;
  String? errorMessage;
  ...
  TestResultChangeLimitDTO.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = [];
      json['data'].forEach((v) {
        data!.add(TestResultChangeLimitDataDTO.fromJson(v));
      });
    }
  }
...
class TestResultChangeLimitDataDTO {
  String? companyId;
  String? siteId;
  String? equipmentId;
  String? timestamp;
  ...
  TestResultChangeLimitDataDTO.fromJson(Map<String, dynamic> json) {
