...
class OEESiteQualityMetric extends StatefulWidget {
  OEESiteQualityMetric({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _OEESiteQualityMetric();
  }
}

class _OEESiteQualityMetric extends State<OEESiteQualityMetric> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          Utils.getTranslated(context, 'oee_site_quality_metric')!,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              firstpassyield(context),
              yield(context),
              qualitymetric(context),
            ],
          ),
        ),
      ),
        ...
        children: [
          Row(
            ...
            children: [
              Expanded(
                child: Text(
                  Utils.getTranslated(ctx, 'oee_site_quality_metric')!,
                  style: AppFonts.robotoRegular(
                    16,
                    color: theme_dark!
                        ? AppColors.appGrey2()
