...
class OEESiteAvailabiltyMetric extends StatefulWidget {
  final int currentTab;
  final String selectedCompany;
  final String selectedSite;
  OEESiteAvailabiltyMetric(
      {Key? key,
  ...
  State<StatefulWidget> createState() {
    return _OEESiteAvailabiltyMetric();
  }
}

class _OEESiteAvailabiltyMetric extends State<OEESiteAvailabiltyMetric> {
  int currentTab = 0;
  ...
  OeeSummaryPerecentageDTO oeeSummarydata = OeeSummaryPerecentageDTO();
  Future<OeeSummaryPerecentageDTO> getAggregatedSummary(BuildContext context) {
    OeeApi oeeApi = OeeApi(context);
    return oeeApi.getAggregatedSummary(
      widget.selectedCompany,
      widget.selectedSite,
    );
  }
  ...
  Future<OeeSummaryDTO> getAggregatedAvailabilityBySite(
    ...
    OeeApi oeeApi = OeeApi(context);
    return oeeApi.getAggregatedAvailabilityBySite(
        widget.selectedCompany,
        widget.selectedSite,
  ...
  Future<OeePerformanceDTO> getAggregatedPerformanceBySite(
      BuildContext context, DateTime startDate, DateTime endDate) {
    OeeApi oeeApi = OeeApi(context);
    return oeeApi.getAggregatedPerformanceBySite(
        widget.selectedCompany,
        widget.selectedSite,
        DateFormat("yyyyMMdd").format(startDate),
        DateFormat("yyyyMMdd").format(endDate));
  ...
  Future<OeeQualityDTO> getAggregatedQualityBySite(
      BuildContext context, DateTime startDate, DateTime endDate) {
    OeeApi oeeApi = OeeApi(context);
    return oeeApi.getAggregatedQualityBySite(
        widget.selectedCompany,
        widget.selectedSite,
        DateFormat("yyyyMMdd").format(startDate),
        DateFormat("yyyyMMdd").format(endDate));
  ...
  void initState() {
    ...
    Utils.setFirebaseAnalyticsCurrentScreen(
        Constants.ANALYTICS_OEE_SUMMARY_SITE_AVAILABILITY_SCREEN);
    FocusManager.instance.primaryFocus?.unfocus();
    setState(() {
      currentTab = widget.currentTab;
      siteAxisRangeList[currentTab].isSelected = true;
    });
  ...
  callListSiteOEE(BuildContext context) async {
    ...
    await getAggregatedSummary(context).then((value) {
      oeeSummarydata = value;
      //print(oeeDUTdata);
    }).catchError((error) {
      Utils.printInfo(error);
    });
    await getAggregatedAvailabilityBySite(
            context,
    ...
    await getAggregatedPerformanceBySite(
            context,
            AppCache.sortFilterCacheDTO!.startDate!,
            AppCache.sortFilterCacheDTO!.endDate!)
        .then((value) {
    ...
    await getAggregatedQualityBySite(
            context,
            AppCache.sortFilterCacheDTO!.startDate!,
            AppCache.sortFilterCacheDTO!.endDate!)
        .then((value) {
  ...
  Widget build(BuildContext context) {
    if (currentTab == 0) {
      title = Utils.getTranslated(context, 'oee_site_availability_metric')!;
    } else if (currentTab == 1) {
      title = Utils.getTranslated(context, 'oee_site_quality_metric')!;
    } else if (currentTab == 2) {
      title = Utils.getTranslated(context, 'oee_site_performance_metric')!;
    }
    return Scaffold(
      appBar: AppBar(
          ...
          Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext ctx, int index) {
                return rangeItem2(ctx, siteAxisRangeList[index], index,
  ...
  Widget rangeItem2(BuildContext ctx, PDate siteList, int index, int length) {
    var summaryPercentage = "";
    var title = "";
    if (siteList.rangeName!.contains('Availability')) {
      summaryPercentage = oeeSummarydata.data!.availability!.toStringAsFixed(2);
      title = Utils.getTranslated(context, 'oee_chart_availability')!;
    } else if (siteList.rangeName!.contains('Quality')) {
      summaryPercentage = oeeSummarydata.data!.quality!.toStringAsFixed(2);
      title = Utils.getTranslated(context, 'oee_chart_quality')!;
    } else if (siteList.rangeName!.contains('Performance')) {
      summaryPercentage = oeeSummarydata.data!.performance!.toStringAsFixed(2);
      title = Utils.getTranslated(context, 'oee_chart_perfornance')!;
    } else if (siteList.rangeName!.contains('OEE')) {
      summaryPercentage = oeeSummarydata.data!.oee!.toStringAsFixed(2);
      title = Utils.getTranslated(context, 'oee_chart_oee')!;
    }
    return Row(
      mainAxisAlignment: MainAxisAlignment.start,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        GestureDetector(
            ...
            (siteList.route) != null
                ? setState(
                    () {
                      ...
                      siteAxisRangeList.forEach((value) {
                        value.isSelected = false;
                      });
                      siteList.isSelected = true;
                    },
                  )
                : Navigator.pop(ctx);
          },
          child: Container(
            ...
            decoration: BoxDecoration(
              color: siteList.isSelected!
                  ? theme_dark!
                      ? AppColors.appPrimaryWhite()
                      : AppColorsLightMode.appPrimaryYellow()
                  : Colors.transparent,
              border: siteList.isSelected!
                  ? Border.all(color: Colors.transparent)
                  : Border.all(color: AppColors.appMediumGrey()),
              borderRadius: BorderRadius.circular(50.0),
            ),
              ...
              InkWell(
                onTap: () {
                  if (getAvailabilityBySiteDTO.data != null &&
                    ...
                    Navigator.pushNamed(
                      ctx,
                      AppRoutes.oeeSummarySiteMetricDetail,
                      arguments: OeeChartDetailArguments(
                          chartName: Utils.getTranslated(
                              context, 'oee_totalUtilizationTimebyEquipment')!,
                          dataType: '0',
                ...
                onTap: () {
                  if (getAvailabilityBySiteDTO.data != null &&
                    ...
                    Navigator.pushNamed(
                      ...
                      arguments: OeeChartDetailArguments(
                          chartName: Utils.getTranslated(
                              context, 'oee_totalAvailableTimebyEquipment')!,
                          dataType: '1',
                          selectedCompany: widget.selectedCompany,
                          selectedSite: widget.selectedSite,
                          currentTab: currentTab),
                ...
                onTap: () {
                  if (getAvailabilityBySiteDTO.data != null &&
                    ...
                    Navigator.pushNamed(
                      ...
                      arguments: OeeChartDetailArguments(
                          chartName: Utils.getTranslated(
                              context, 'oee_totalPlannedimebyEquipment')!,
                          dataType: '2',
                          selectedCompany: widget.selectedCompany,
                          selectedSite: widget.selectedSite,
                          currentTab: currentTab),
                ...
                onTap: () {
                  if (getQualityBySiteDTO.data != null &&
                    ...
                    Navigator.pushNamed(
                      ...
                      arguments: OeeChartDetailArguments(
                          chartName: Utils.getTranslated(
                              ctx, 'oee_retestpassfailbyEquipment')!,
                          dataType: '0',
                          selectedCompany: widget.selectedCompany,
                          selectedSite: widget.selectedSite,
                          currentTab: currentTab),
                ...
                onTap: () {
                  if (getQualityBySiteDTO.data != null &&
                    ...
                    Navigator.pushNamed(
                      ...
                      arguments: OeeChartDetailArguments(
                          chartName: Utils.getTranslated(
                              ctx, 'oee_firstpassyieldbyEquipment')!,
                          dataType: '1',
                          selectedCompany: widget.selectedCompany,
                          selectedSite: widget.selectedSite,
                          currentTab: currentTab),
                ...
                onTap: () {
                  if (getQualityBySiteDTO.data != null &&
                    ...
                    Navigator.pushNamed(
                      ...
                      arguments: OeeChartDetailArguments(
                          chartName:
                              Utils.getTranslated(ctx, 'oee_yieldbyEquipment')!,
                          dataType: '2',
                          selectedCompany: widget.selectedCompany,
                          selectedSite: widget.selectedSite,
                          currentTab: currentTab),
            ...
            Row(
              ...
              children: [
                Expanded(
                  ...
                  child: Text(
                    Utils.getTranslated(
                        context, 'oee_summary_metric_utiltime')!,
                    style: AppFonts.robotoMedium(
                      14,
            ...
            Row(
              ...
              children: [
                Expanded(
                  ...
                  child: Text(
                    Utils.getTranslated(
                        context, 'oee_summary_metric_availtime')!,
                    style: AppFonts.robotoMedium(
                      14,
            ...
            Row(
              ...
              children: [
                Expanded(
                  ...
                  child: Text(
                    Utils.getTranslated(
                        context, 'oee_summary_metric_plannedowntime')!,
                    style: AppFonts.robotoMedium(
                      14,
            ...
            Row(
              ...
              children: [
                Expanded(
                  ...
                  child: Text(
                    Utils.getTranslated(
                        context, 'oee_summary_metric_downtime')!,
                    style: AppFonts.robotoRegular(
                      16,
            ...
            Row(
              ...
              children: [
                Expanded(
                  ...
                  child: Text(
                    Utils.getTranslated(
                        context, 'oee_summary_metric_Availability')!,
                    style: AppFonts.robotoRegular(
                      16,
