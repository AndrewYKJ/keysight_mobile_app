  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      ...
                      child: Image.asset(theme_dark!
                          ? Constants.ASSET_IMAGES + 'calendar_prev_bttn.png'
                          : Constants.ASSET_IMAGES_LIGHT +
                              'calendar_prev_bttn.png'),
                    ),
                  ),
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      ...
                      child: Image.asset(theme_dark!
                          ? Constants.ASSET_IMAGES + 'calendar_next_bttn.png'
                          : Constants.ASSET_IMAGES_LIGHT +
                              'calendar_next_bttn.png'),
                    ),
                  ),
                ),
              ),
        ...
        Padding(
          padding: const EdgeInsets.fromLTRB(25.0, 31.0, 25.0, 41.0),
          child: Row(
